...
function zvm_after_select_vi_mode() {
  case $ZVM_MODE in
      $ZVM_MODE_NORMAL)
          PROMPT="%{$fg[yellow]%}[N] %{$fg[blue]%}%3~ %{$fg[red]%}❭%{$fg[yellow]%}❭%{$fg[green]%}❭%{$reset_color%}%b ";;
      $ZVM_MODE_INSERT)
          PROMPT="%{$fg[yellow]%}[I] %{$fg[blue]%}%3~ %{$fg[red]%}❭%{$fg[yellow]%}❭%{$fg[green]%}❭%{$reset_color%}%b ";;
      $ZVM_MODE_VISUAL)
          PROMPT="%{$fg[yellow]%}[v] %{$fg[blue]%}%3~ %{$fg[red]%}❭%{$fg[yellow]%}❭%{$fg[green]%}❭%{$reset_color%}%b ";;
      $ZVM_MODE_VISUAL_LINE)
          PROMPT="%{$fg[yellow]%}[V] %{$fg[blue]%}%3~ %{$fg[red]%}❭%{$fg[yellow]%}❭%{$fg[green]%}❭%{$reset_color%}%b ";;
      $ZVM_MODE_REPLACE)
        PROMPT="%{$fg[yellow]%}[R] %{$fg[blue]%}%3~ %{$fg[red]%}❭%{$fg[yellow]%}❭%{$fg[green]%}❭%{$reset_color%}%b ";;
  esac
}
